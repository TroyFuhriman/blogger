<template>
  <div class="col-md-4 col-12 blogs mt-3">
    <div class="card">
      <span
        type="button"
      ...
      <div class="text-center" v-if="blogs.creatorEmail == profile.email">
        <button @click="form = !form" class="btn btn-warning">Edit</button>
